...
session.setAttribute("2fa_expiration", expirationTime);
            ...
            if (emailSent) {
                ...
                // Em caso de falha no envio do e-mail, pode-se optar por falhar o login ou permitir o acesso sem 2FA (não recomendado)
                jsonResponse.put("status", "error");
...
session.removeAttribute("2fa_expiration");
    ...
    private String generate2FACode() {
        ...
        int code = 100000 + random.nextInt(900000); // Gera um número de 6 dígitos
